...
export const BlendMode = {
  ...
  MULTIPLY_PM: _createBlendMode([Const.DST_COLOR, Const.ONE_MINUS_SRC_ALPHA, Const.ONE, Const.ONE_MINUS_SRC_ALPHA]),
  SCREEN_PM: _createBlendMode([Const.ONE, Const.ONE_MINUS_SRC_COLOR, Const.ONE, Const.ONE_MINUS_SRC_ALPHA]),
  ...
  NORMAL: _createBlendMode([Const.SRC_ALPHA, Const.ONE_MINUS_SRC_ALPHA, Const.ONE, Const.ONE_MINUS_SRC_ALPHA]),
  ADD: _createBlendMode([Const.SRC_ALPHA, Const.DST_ALPHA, Const.ONE, Const.DST_ALPHA]),
  MULTIPLY: _createBlendMode([Const.DST_COLOR, Const.ZERO]),
  SCREEN: _createBlendMode([Const.SRC_ALPHA, Const.ONE_MINUS_SRC_COLOR, Const.ONE, Const.ONE_MINUS_SRC_COLOR]),
  OVERLAY: _createBlendMode([Const.ONE, Const.ONE_MINUS_SRC_ALPHA]),
  EXCLUSION: _createBlendMode([Const.ONE_MINUS_DST_COLOR, Const.ONE_MINUS_SRC_COLOR]),
