 ...
 *
 * @param {WebGL2RenderingContext} context Original WebGL context.
 ...
 * @returns {WebGL2RenderingContext} Proxy-wrapped context.
 */
export const debugContext = (context, options = {}) => {
  ...
  const constMap =
    typeof WebGL2RenderingContext !== "undefined"
      ? Object.entries(WebGL2RenderingContext).reduce((acc, [name, value]) => {
          acc[value] = name;
          return acc;
        }, {})
      : {};
