...
const _COLORS = {
  ...
  PROGRAM: _createFormat("🧠", "PROGRAM", "#7CFF9B", "#0b3d1f"),
  BINDING: _createFormat("🔗", "BIND", "#4FC3F7", "#002233"),
  RESOURCES: _createFormat("📦", "RESOURCE", "#FFD54F", "#3a2a00"),
  BUFFER_UPLOAD: _createFormat("🚚", "UPLOAD", "#FF7043", "#3b1200"),
  TEXTURE_PARAMS: _createFormat("🖼️", "TEX", "#c792ea", "#2a1433"),
  UNIFORMS: _createFormat("🎛️", "UNIFORM", "#FF7AA2", "#2a0f1a"),
  VERTEX_ATTRIBUTES: _createFormat("🧩", "ATTR", "#26E6A6", "#00382f"),
  VIEWPORT: _createFormat("🖥️", "FRAME", "#90a4ae", "#1c262b"),
  BLENDING: _createFormat("🌫️", "BLEND", "#69f0ae", "#032"),
  SAMPLERS: _createFormat("🎚️", "SAMPLER", "#000", "#33F"),
  FRAMEBUFFERS: _createFormat("🪟", "FBO", "#fff", "#4a148c"),
  RENDERBUFFERS: _createFormat("🧱", "RBO", "#fff", "#004d40"),
  DEPTH_STENCIL: _createFormat("📐", "DEPTH", "#999", "#333"),
  DRAW: _createFormat("🔴", "DRAW", "#fff", "#d50000"),
  ALERT: _createFormat("🛑", "ALERT", "#fff", "#b00020"),
  WARN: _createFormat("⚠️", "WARN", "#000", "#fc0"),
};
