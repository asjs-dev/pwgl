...
const _COLORS = {
  ...
  TEXTURE_PARAMS: _createFormat("▦", "TEX", "#c792ea", "#2a1433"),
  UNIFORMS: _createFormat("≡", "UNIFORM", "#FF7AA2", "#2a0f1a"),
  VERTEX_ATTRIBUTES: _createFormat("▣", "ATTR", "#26E6A6", "#00382f"),
  VIEWPORT: _createFormat("▢", "FRAME", "#90a4ae", "#1c262b"),
  BLENDING: _createFormat("≈", "BLEND", "#69f0ae", "#032"),
  SAMPLERS: _createFormat("⇅", "SAMPLER", "#000", "#33F"),
